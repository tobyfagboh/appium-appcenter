...
public class Signup extends TestBase {
	...
	String letsGetStarted4_XPATH = "//android.widget.TextView[@text='Let's Get Started']";
	...
	//Signup
	String firstname11_XPATH = "//android.widget.TextView[@text='First name']";
	String firstname22_XPATH = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup/android.widget.TextView";
	...
	String lastname2_XPATH = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[3]/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup/android.widget.TextView";
	...
	String checkbox_XPATH = "//android.widget.EditText[@text='\\uF2BC']";
	...
	//#Dashboard
		...
		String timelineBtn_XPATH = "//android.widget.Button[@content-desc=\"Timeline, tab, 2 of 2\"]";
		//#existing user
		...
		String addContact_XPATH = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.widget.HorizontalScrollView/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView[2]";
		String yesUnderstandBtn_XPATH = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView";
		...
		//#VirtualAssistance
		String virtualAss_XPATH = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.widget.HorizontalScrollView/android.view.ViewGroup/android.view.ViewGroup[3]/android.view.ViewGroup/android.widget.TextView";
	...
	public void signupTest () throws IOException, InterruptedException  {
		...
		driver.findElement(By.xpath(letsGetStarted3_XPATH)).click();
		log.info("Lets Get Started clicked");
		
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath(firstname22_XPATH )).sendKeys(firstname_TEXT);
		log.info("user firstname passed into text box");	
		
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath(lastname2_XPATH)).sendKeys(lastname_TEXT);
		log.info("user lastname passed into text box");
		
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath(signUpEmail_XPATH)).sendKeys(signUpEmail_TEXT);
		log.info("user email passed into text box");	
		
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath(signUpPassword_XPATH)).sendKeys(signUpPassword_TEXT);
		log.info("user password passed into text box");
		
		//driver.swipe(688, 1260, 688, 1124, 1467);

		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath(confirmPassword_XPATH)).sendKeys(confirmPassword_TEXT);
		log.info("user confirm password passed into text box");	
		
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath(checkbox2_XPATH)).click();
		...
		driver.findElement(By.xpath(skipPhoneNumber_XPATH)).click();
		...
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		driver.findElement(By.xpath(deactivateAccount_XPATH)).click();
		log.info("Deactivate button clicked");
		
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElement(By.xpath(confirmBtn_XPATH)).click();
		log.info("Confirm button clicked");
		
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		String actualString = driver.findElement(By.xpath(letsGetStarted2_XPATH)).getText();
	    assertTrue(actualString.contains(letsGetStartedText));
